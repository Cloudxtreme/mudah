import  { animation as collide_animation } from '/imports/ui/3rdparty/ionic-tinder-cards-2/collide';
...
(function(ionic) {
  ...
  angular.module('ionicTinder2', ['ionic'])
  ...
  console.log("----- compile -----");
          ...
          var swipeableCard = new SwipeableCardView({
            ...
            onSnapBack: function(startX, startY, startRotation) {
              ...
              var animation = collide_animation({
...
console.log("now ...sortCards() ");
          ...
          for(i = 0; i < existingCards.length; i++) {
            ...
            console.log("--> in sortcards set zIndex = " + (existingCards.length - i) );
        ...
        $timeout(function() {
          sortCards();
        }, 1000);  //  This is the SECRET !! Wait 1 second for all the <td-card>s to be rendered first !!
